...
public class QRCodeUtilConstant {
    public final static int Q_R_CODE_WIDTH = 300; // 图像宽度
    public final static int Q_R_CODE_HEIGHT = 300; // 图像高度
    ...
    static {
        ...
        Q_R_CODE_ENCODE_HINTS.put(EncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.M);
